...
Call `get_brand_context` to read the current Brand Context projection from the brain before editing. Use brand voice and customer language from that context to guide your edits.
